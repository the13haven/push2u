...
module com.the13haven.push2u {
    ...
    // this artifact free of any runtime dependency on the module path as well as the class path. A
    // consumer that does care puts it on the path and reads the annotations as usual.
