...
/**
 * HKDF (RFC 5869) over HMAC-SHA-256, hand-rolled in ~25 lines so the library keeps no runtime implementation
 * dependencies. It is deliberately NOT an extension point: the bytes are identical regardless of implementation, and a
 * pluggable seam here would fail silently as wrong ciphertext.
 *
