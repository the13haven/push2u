...
public interface VapidSigner {
    ...
    /**
     * Sign the JWT signing input (the ASCII {@code base64url(header) || "." || base64url(claims)})
     * with ES256, returning the raw {@code r || s} pair (64 bytes for P-256) that JOSE expects —
