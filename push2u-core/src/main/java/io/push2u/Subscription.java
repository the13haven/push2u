...
/**
 * A Web Push subscription as handed to the application by the browser: the push endpoint URL
 ...
 *
 * <p>The array components are defensively copied in the compact constructor and the accessors,
