...
/**
 * {@link LocalEcVapidSigner} bound to a stock BouncyCastle provider instance (not registered
 * with {@code java.security.Security}) satisfies the shared {@link VapidSignerContractTest}:
 * bcprov registers raw-format ECDSA, so this runs the direct P1363 path — the contract's
 * verification against a platform P1363 verifier proves the two providers interoperate.
 */
