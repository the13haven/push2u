...
its status line, or, when only one clause moves, the narrower `Accepted; one clause superseded by
ADR-NNN` beside the full form — and `docs/adr/README.md` carries the procedure for both.
