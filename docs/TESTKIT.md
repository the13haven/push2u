...
a body — the given values are synthetic, but a defective transport's output is not, and the
contract's failures go to the same build log a leaked value would.
