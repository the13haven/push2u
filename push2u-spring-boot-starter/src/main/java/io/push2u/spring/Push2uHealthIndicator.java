 ...
 *
 * <p>Registered only when a {@link io.push2u.PushSender} is configured (see {@link Push2uHealthAutoConfiguration}), so
 * "the sender is wired" is the precondition and "the signer can sign" is the live check.
 */
